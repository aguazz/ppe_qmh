...
\begin{minipage}{0.65\textwidth}
    ...
    \begin{minipage}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{img/Kosuke_book.jpg}
    \end{minipage}
\end{frame}
...
\begin{center}
    \includegraphics[width=\textwidth,height=0.7\textheight]{img/mastering_metrics.png} \\[1em]
...
\begin{minipage}{0.31\textwidth}
\begin{center}
    \includegraphics[width=\textwidth,height=0.7\textheight]{img/social_research_method.png} \\[1em]
...
\begin{minipage}{0.31\textwidth}
\begin{center}
    \includegraphics[width=\textwidth,height=0.7\textheight]{img/wooldridge.png} \\[1em]
