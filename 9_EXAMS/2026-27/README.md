...
- Keep each `.tex` source next to the PDF it generates.
- Use matching basenames for source and PDF files.
- Keep any exam-specific assets, such as logos, inside this folder.
- Leave `9_EXAMS/2024-25/` and `9_EXAMS/2025-26/` untouched unless explicitly using them as historical references.
- Do not copy 2025-26 exam language blindly into 2026-27 materials; the 2026-27 course has two midterms and optional R.
