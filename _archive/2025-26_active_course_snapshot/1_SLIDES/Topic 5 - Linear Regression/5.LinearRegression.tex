...
\begin{center}
    \includegraphics[scale=0.3]{../../LaTex/img/RLM.png}
\end{center}
\end{frame}
...
%     \centering
%     \includegraphics[scale = 0.4]{../../LaTex/img/residuals-vs-fitted.png} 
% \end{minipage}
...
% \begin{minipage}{0.5\textwidth}
%     \centering
%     \includegraphics[scale = 0.4]{../../LaTex/img/Q-Q-plot.png} 
% \end{minipage}
% \begin{minipage}{0.45\textwidth}
...
% \begin{minipage}{0.5\textwidth}
%     \centering
%     \includegraphics[scale = 0.4]{../../LaTex/img/standard-residuals-vs-fitted.png} 
% \end{minipage}
% \begin{minipage}{0.45\textwidth}
...
%     \includegraphics[scale = 0.4]{../../LaTex/img/residual-vs-fitted-plots.png} 
% \end{minipage}
% \begin{minipage}{0.32\textwidth}
%     \centering
%     {\tiny Q-Q plot}
%     \includegraphics[scale = 0.4]{../../LaTex/img/QQ-plots.png} 
% \end{minipage}
% \begin{minipage}{0.32\textwidth}
%     \centering
%     {\tiny Standard residuals vs fitted values}
%     \includegraphics[scale = 0.4]{../../LaTex/img/standard-residuals-vs-fitted-plots.png} 
% \end{minipage}
...
\begin{minipage}{0.45\textwidth}
    \begin{center}
        \includegraphics[width=7cm]{../../LaTex/img/faces.png} % Adjust the width as needed
...
\includegraphics[scale=0.45]{../../LaTex/img/linear-transformation.png}
...
\begin{frame}{The Simpson Paradox}
    ...
    \begin{center}
        \animategraphics[loop, autoplay, width=0.6\linewidth]{12}{../../LaTex/simpson/Simpsons_paradox_-_animation-}{0}{48}
        \vspace{0.3cm}
...
\begin{minipage}{0.65\textwidth}
    \begin{center}
    \includegraphics[scale=0.41]{../../LaTex/img/RDD.png}
\end{center}    
\end{minipage}
