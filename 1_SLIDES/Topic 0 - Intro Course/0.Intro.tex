...
\begin{itemize}
    ...
    \item \textbf{Office hours:} Arranged by email.
    \item \textbf{Software:} R/RStudio may be used for optional enrichment and instructor-led case-study demonstrations. Required assessment does not depend on students writing code.
    \item \textbf{Evaluation:} 
    \begin{itemize}
        \item[$\bullet$] Continuous evaluation $40\%$
        \begin{itemize}
            \item[-] $10\%$ Quizzes and short checks on course content
            \item[-] $10\%$ Midterm exam 1
            \item[-] $10\%$ Paper-analysis group project
            \item[-] $10\%$ Midterm exam 2
        \end{itemize}
        \item[$\bullet$] Final exam $60\%$
        \begin{itemize}
            \item[-] Covers all course content
...
\begin{minipage}{0.65\textwidth}
    ...
    \begin{itemize}
        \item \textbf{Hands-On Learning:} Illustrates concepts with real-world case studies.
        \item \textbf{Empirical examples:} Connects probability, causality, and statistical reasoning to social-science questions.
...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{Tools of QM:} Statistical reasoning, research design, data collection, and, when useful, programming.
        \vspace{0.3cm}
