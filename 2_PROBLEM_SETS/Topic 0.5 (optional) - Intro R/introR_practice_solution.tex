...
\title{Optional Practice Solution. Introduction to R \\ Quantitative Methods for Humanities}
...
\begin{center}
    ...
    This solution corresponds to the optional Intro R practice. It is not part of the required continuous evaluation unless explicitly assigned by the instructor.
\end{center}
\vspace{0.3cm}

\begin{center}
    \textbf{\large Understanding World Population Dynamics}    
\end{center}
