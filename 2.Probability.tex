...
\begin{frame}{Solution to the Birthday Problem}
    \vspace{0.2cm}
    \centering
    \includegraphics[scale=0.25]{img/birthday_problem_plot.png} 
\end{frame}
...
\begin{frame}{Example. Acrostic by change?}
    ...
    \begin{center}
        \includegraphics[height=4.8cm, width=14cm]{img/Arnol_message.png}
    \end{center}
    \vspace{-0.2cm}
...
\begin{frame}{Visualization of the Bernoulli distribution}
    \begin{center}
    \includegraphics[scale=0.35]{img/bernoulli_distribution.png}
    \end{center}
\end{frame}
...
\begin{frame}{Visualization of the uniform distribution}
    \begin{center}
    \includegraphics[scale=0.35]{img/uniform_distribution.png}
    \end{center}
\end{frame}
...
\begin{frame}{Visualization of the binomial distribution}
    \begin{center}
    \includegraphics[scale=0.35]{img/binomial_distribution.png}
    \end{center}
\end{frame}
...
\begin{frame}{Visualization of the normal distribution}
    \begin{center}
    \includegraphics[scale=0.35]{img/normal_distribution.png}
    \end{center}
\end{frame}
...
\begin{frame}{Illustrating LLN}
    ...
    \texttt{n <- 1000 \# number of simulations \\ 
        ...
        \begin{minipage}{0.55\textwidth}
            \begin{center}
                \includegraphics[width=0.9\textwidth, height = 4.5cm]{img/LLN.png}    
            \end{center}
        \end{minipage}
\end{frame}
...
\begin{frame}{Illustrating CLT}
    ...
    \begin{center}
        \includegraphics[width=0.9\textwidth]{img/CLT.png}    
    \end{center}
\end{frame}
